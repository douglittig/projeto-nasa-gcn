...
# MAGIC
# MAGIC 1. Find the endpoint you created and click the **Edit** button on the endpoint page. 
# MAGIC
...
# MAGIC <br>
# MAGIC
# MAGIC ![genai-as-04-realtime-inference](files/images/generative-ai-deployment-and-monitoring-2.0.2/genai-as-04-realtime-inference.png)
# MAGIC
