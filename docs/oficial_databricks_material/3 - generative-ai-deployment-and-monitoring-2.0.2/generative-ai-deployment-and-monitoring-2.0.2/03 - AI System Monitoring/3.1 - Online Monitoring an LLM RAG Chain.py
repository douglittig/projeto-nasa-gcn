...
# MAGIC ![llm-eval-online-1](files/images/generative-ai-deployment-and-monitoring-2.0.2/llm-eval-online-1.png)
...
# MAGIC
# MAGIC ![lakehouse-monitoring-overview](files/images/generative-ai-deployment-and-monitoring-2.0.2/lakehouse-monitoring-overview.png)
# MAGIC
# MAGIC
...
# MAGIC
# MAGIC ![llm-eval-online-2](files/images/generative-ai-deployment-and-monitoring-2.0.2/llm-eval-online-2.png)
# MAGIC
...
# MAGIC <br>
# MAGIC
# MAGIC ![genai-as-04-online-monitoring-config](files/images/generative-ai-deployment-and-monitoring-2.0.2/genai-as-04-online-monitoring-config.png)
# MAGIC
...
# MAGIC <br>
# MAGIC
# MAGIC ![genai-as-04-online-monitoring-quality](files/images/generative-ai-deployment-and-monitoring-2.0.2/genai-as-04-online-monitoring-quality.png)
# MAGIC
# MAGIC
...
# MAGIC <br>
# MAGIC
# MAGIC ![dashboard](files/images/generative-ai-deployment-and-monitoring-2.0.2/dashboard.png)
