# projeto-nasa-gcn
Esse repositório tem o objetivo de armazenar meu material de estudos para as provas de certificação, desenvolvendo um projeto real de consumo de dados da NASA.
...
The 'nasa_gcn' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] nasa_gcn_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/nasa_gcn.job.yml). The schedule
